...
class BaseEntityDB(BaseEntityObject):
    ...
    def update(self, entity_ids: Union[List[str], str], skip_on_exist=False, plugin_type=None):
        ...
        for entity_id in entity_ids:
            ...
            content = self.entity_class.from_server_url(
                query_params={self.query_param_field: [entity_id]}, plugin_type=plugin_type
            )
