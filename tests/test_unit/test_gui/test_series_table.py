...
def test_series_table(mock_ui_table):
    ...
    mock_ui_table.return_value = mock_table
    ...
    expected_columns = [
        ...
        {"name": "latest_chapter_date", "label": "Chapter Updated", "field": "latest_chapter_date", "sortable": True},
        {"name": "tracked", "label": "Tracked", "field": "tracked", "sortable": True},
