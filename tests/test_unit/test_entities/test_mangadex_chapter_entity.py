...
def test_chapter_entity(chapter_request_content):
    entity = ChapterEntityMangaDex(content=chapter_request_content)
...
def test_chapter_from_url(chapter_request_response):
    with mock.patch("cbz_tagger.entities.chapter_plugins.ChapterEntityMangaDex.unpaginate_request") as mock_request:
        mock_request.return_value = chapter_request_response["data"]
        entities = ChapterEntityMangaDex.from_server_url(
...
@patch("cbz_tagger.entities.chapter_plugins.ChapterEntityMangaDex.request_with_retry")
...
@patch("cbz_tagger.entities.chapter_plugins.ChapterEntityMangaDex.download_file")
